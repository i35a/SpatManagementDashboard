 ...
 * @author PC
 */
public class Service_indicateur_rh {
    public static List<V_indicateur_rh> getIndicateurRH() {
        List<V_indicateur_rh> list = new ArrayList<>();
        String sql = "SELECT * FROM v_indicateur_rh";
        ...
        try (Connection cnx = DBConnectionOld.getConnection();
            ...
            while (rs.next()) {
                V_indicateur_rh r = new V_indicateur_rh();
    ...
    public static List<V_indicateur_rh> getIndicateurRH_actuel() {
        List<V_indicateur_rh> list = new ArrayList<>();
        String sql = "SELECT * FROM v_indicateur_rh where "
    ...
    public static boolean update(V_indicateur_rh r) {
        String sql = "UPDATE indicateur_rh SET " +
    ...
    public static Object getByMois(V_indicateur_rh indic, String mois) {
