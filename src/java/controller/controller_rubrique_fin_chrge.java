 ...
 * @author PC
 */
@WebServlet("/rubrique_fin_chrge")
public class controller_rubrique_fin_chrge extends HttpServlet {
...
// 2. Création de l'objet Gson (compatible 2.2.2)
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(controller_rubrique_fin_chrge.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
